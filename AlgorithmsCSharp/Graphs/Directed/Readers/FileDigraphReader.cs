...
public interface IDigraphGraphReader
{
    IDigraph ReadFromFile(string path);
}

public class FileDigraphReader : IDigraphGraphReader
{
    public IDigraph ReadFromFile(string path)
    {
        ...
        var graph = new Digraph(verticies);
